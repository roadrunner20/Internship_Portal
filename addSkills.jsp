	...
	<ul class="nav nav-tabs">
	  ...
	  <li ><a href="internPosting.jsp">Add Internship </a></li>
	   <li><a href="addSkillGroup.jsp">Add Skill Groups</a></li>
	    <li class="active"><a href="addSkills.jsp">Add Skills</a></li>
...
<br> 
  ...
  <!--    <input placeholder="Search by Job Group ID" type = "search" size ="40"  name = "search"/> -->     
   ...
   <button type = "submit" class="btn btn-info" name="delete"  onclick="return remover();">Delete</button>
       ...
       PreparedStatement statement = conn.prepareStatement("select skill_id, skill_name, skill_group_id from skill ORDER BY ABS(skill_id)");
   ...
   %>
         ...
         <div align="center">
           <div class="button-container">
       <h4> Skill Names At Glance! </h4>
     
            <table border="1" cellspacing ="3">
     
                <tbody>
                <tr>
                    <th width="120" align="center" font size="1"/>Skill ID</th>
                   <th align="center" font size="1"/>Skill Name</th>
                   <th align="center" font size="1"/>Skill Group ID </th>
       ...
       {  %>
                    ...
                    <tr>
                        ...
                        <td align="center"><%=rs.getString("skill_id")%></td>
                    
                    
                       
                        <td align="center"><%=rs.getString("skill_name")%></td>
