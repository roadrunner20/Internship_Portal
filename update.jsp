...
<script type="text/javascript">
 ...
 {
	 //String search_entered = request.getParameter("search");
	// session.setAttribute("search", search_entered);
...
<ul class="nav nav-tabs">
 ...
 <!--   <li><a href= "updateEduDB.jsp">Educational Details</a></li>
  ...
  <li><a href="updateWork.jsp">Work Experience</a></li>
   <li><a  href="updateSkills.jsp">Competency Level</a></li> -->
