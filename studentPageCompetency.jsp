...
<div class="colorMe">
		...
		<div align="center">
			<ul class="nav nav-tabs">
					  ...
					  <li class="active"><a data-toggle="tab" href=""><b>Skill Competency</b></a></li>
...
%>
 	...
 	<div class="compField" align ="center" id="divEdu">	
		...
		<legend class="lAddCert">Update Skill Level</legend>
		
		<form action="studentPageCompetency.jsp" method="post"  id="f1" name="f1" >
	  ...
	  %>
   	...
   	<%
   			   ...
   			   !level.equals("Select") && level!=null  )
   			{
   				...
   				//UPDATE skill_set
   				//SET student_id=123 ,skill_status= 'Moderately Competent'
   				//WHERE skill='ASP.NET';
   ...
   <div align="center"><a href="studentPageCompInsert.jsp">Return To Skill Evaluation</a></div>
