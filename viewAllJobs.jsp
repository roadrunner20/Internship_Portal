...
<div class="colorMe">
	...
	<div class="head" align="center">
			...
			<font face="Georgia" size="4">Present Jobs In The System</font>
	</div>	
	...
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="viewAllJobs.jsp"> View/Update All Jobs</a></li>
...
<%@ page import = "java.sql.*" %>
  ...
  %>
		...
		<div align="center">
			...
			<form method="post" action="viewAllJobs.jsp">
					Job Group:
	...
	%>
					<tr>
						 ...
						 <td><a href="JobMore.jsp?jobID=<%=rs.getString("intern_post_id")%>">Update</a></td>
						  <td><a href="DelJobs.jsp?jobID=<%=rs.getString("intern_post_id")%>"><button class="button button1">Delete</button></a></td>
