...
<%
	...
	/*	if(student_choice.equalsIgnoreCase("Choose All"))
		...
		String slist = "SELECT first_name, last_name FROM student";
		...
		String str1a = "SELECT first_name, last_name FROM student";
		...
		String str7 = "SELECT student.first_name, student.last_name FROM student INNER JOIN interest ON student.student_id = interest.student_id INNER JOIN internship_posting ON interest.intern_post_id = internship_posting.intern_post_id WHERE (student.country = ?) AND (student.semester =?) AND  (student.year = ?) AND interest.hiring_status IN (?,?,?)";
		// s = con.createStatement();
		// PreparedStatement ps = con.prepareStatement();
		 
		 
	 	if(allList.equals("All Students")  && country.equals("Choose") &&  gpa.equals("Choose") && job_status.equals("Choose") && semester.equals("Choose") && company_name.equals("Choose"))
          {
	 PreparedStatement ps = con.prepareStatement(str1a);
       ...
       out.print("List of all Students");
		...
		else if (country.equals("Choose") && (job_status.equals("Available")) && (year.equals("Choose")) && (semester.equals("Choose")))
		{
			...
			// ps.setString(1, country );
				...
				<p align="center">
			<% 
			out.print("List of All Students from Available for internship  ");	
		...
		else if (!country.equals("Choose") && (job_status.equals("Available")) && (!semester.equals("Choose")) && (!year.equals("Choose")))
		{
			 ...
			 ps.setString(2, semester);
				...
				<p align="center">
			<% 
			out.print("List of Students for     " + semester+ "  " + year + "   from   " + country + "   Available for Internship"); 
		...
		else if (!country.equals("Choose") && (!company_name.equals("Choose")) && (job_status.equals("Choose")) && (semester.equals("Choose")) && (year.equals("Choose")))
		{
			String str9 = "SELECT student.first_name, student.last_name FROM student INNER JOIN interest ON student.student_id = interest.student_id INNER JOIN internship_posting ON interest.intern_post_id = internship_posting.intern_post_id  WHERE student.country=? AND (interest.hiring_status = ? ) AND (internship_posting.company_name = ? ) ";
			 PreparedStatement ps = con.prepareStatement(str9);
			 ps.setString(1, country);
			   ps.setString(2, "Approved");
			   ps.setString(3, company_name);
				...
				<p align="center">
			<% 
			out.print("List of All Students from  " + country + "Currently hired by   " + company_name); 
		}

		else if (!country.equals("Choose") && (!gpa.equals("Choose")) && (company_name.equals("Choose")) && (job_status.equals("Choose")) && (semester.equals("Choose")) && (year.equals("Choose")))
		{
			
			 String str8 = "SELECT student.first_name, student.last_name FROM student INNER JOIN degree_details ON student.student_id = degree_details.student_id WHERE GPA > ? AND student.country=?";	
			 ...
			 ps.setString(2, country);
				...
				<p align="center">
			<% 
			out.print("List of All Students with a GPA higher than   " + gpa); 
		}
