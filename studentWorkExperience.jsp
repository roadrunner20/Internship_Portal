...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="studentWorkExperience.jsp">Work Experience</a></li>
...
<br> 
        ...
        <form name="StudentDataForm" action="studentWorkExpDB.jsp" method="POST">
            <table border="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="companyLocation" value="" size="50" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Position :</td>
                        <td><input type="text" name="position" value="" size="50" /></td>
                    </tr>
           ...
           <a href= "studentWorkExperience.jsp" class="btn btn-info" name="new">Reset</a>
