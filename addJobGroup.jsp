...
<div align="right" class="logout">
	...
	<ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="addJobGroup.jsp">Add Job Groups</a></li>
...
<br> 
  ...
  <!--    <input placeholder="Search by Job Group ID" type = "search" size ="40"  name = "search"/> -->     
       ...
       <div align="left">
        <form name="" action="jobGroupDB.jsp" method="POST">
            <table border="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td><input type="hidden" name="jobPositionID" value="DND" size="50" /></td>
                    </tr>
        ...
        <br><br>
        <div align="right">
     	<form name="" action="updateGroupDB.jsp" method="POST">
            <table border="0">
              ...
              <p align="right" > <button type = "submit" class="btn btn-info" name="update"  >Update Values</button></p>
        </form>
        </div>
        <div align="right">
       <form name="" action="updateGroupDB.jsp" method="POST">
       ...
       PreparedStatement statement = conn.prepareStatement("select job_group_id, job_category_title from job_group ORDER BY ABS(job_group_id)");
   ...
   %>
       ...
       {  %>
                    ...
                    <tr>
                        ...
                        <td align="center"><%=rs.getString("job_group_id")%></td>
                    
                    
                       
                        <td align="center"><%=rs.getString("job_category_title")%></td>
                    </tr>
